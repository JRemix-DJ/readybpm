                ...
                <table class="row" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="text-align: left;">
                      ...
                      <div class="sans-serif" style="color: #969AA1; font-size: 18px; font-weight: 400; line-height: 28px; margin-bottom: 20px;">Confirma tu correo</div>
                    </th>
                  </tr>
                </table>
              </th>
          ...
          <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
            ...
            <tr class="mobile-valign-top">
              <td style="padding: 20px; font-size: 16px; ">
                  Confirma tu correo electr܇nico para poder ingresar a nuestra plataforma. Para hacerlo haz click en el siguiente enlace:<br><br>
                  <a href="http://localhost/readybpm/confirmaccount/?email=<? echo $email; ?>&token=<? echo $token; ?>" style="background: darkred; padding: 10px; color: white; border-radius: 7px; text-align: center; ">CONFIRMAR</a>
              </td>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
