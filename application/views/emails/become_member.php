        ...
        <td style="padding: 30px 0;">
            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                <a href="https://readybpm.com" style="text-decoration: none;">
                  <img class="mobile-center" src="https://readybpm/images/logocorto.png" width="105" alt="ReadyBPM" style="border: 0; width: 100%; max-width: 105px;">
                </a>
              </th>
            </tr>
            <tr>
                ...
                <table class="row" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="text-align: left;">
                      <div class="serif" style="color: #1F2225; font-size: 28px; font-weight: 700; line-height: 50px; margin-bottom: 30px;">Hola Administrador,</div>
                      <div class="sans-serif" style="color: #969AA1; font-size: 18px; font-weight: 400; line-height: 28px; margin-bottom: 40px;">Haz recibido una nueva solicitud para ser miembro en ReadyBPM</div>
                    </th>
                  </tr>
                </table>
              </th>
          ...
          <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
            ...
            <tr class="mobile-valign-top">
              <td style="padding: 20px"><? echo $mensaje; ?></td>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
            </tr>
                        ...
                        <tr>
                          <td style="padding-left: 0;">
                            <a href="https://www.facebook.com/profile.php?id=61576190996039" style="text-decoration: none;">
                              <img src="https://readybpm/images/icons/facebook.png" width="24" alt="Facebook" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                          <td>
                            <a href="https://www.instagram.com/readybpm/" style="text-decoration: none;">
                              <img src="https://readybpm/images/instagram.png" width="24" alt="Instagram" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                        </tr>
                      </table>
