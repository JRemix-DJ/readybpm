      ...
      <table class="container">
                  ...
                  <table class="items-table">
                    ...
                    <tr>
                      <td class="item-row-main">
                        ...
                        <p class="item-description"><?php echo ($is_plan) ? 'Plan de ' . $item->duration . ' días' : 'Producto individual'; ?></p>
                      </td>
        ...
        <tr>
          <td class="footer">
            ...
            <p>&copy; <?php echo date('Y'); ?> ReadyBPM. Todos los derechos reservados.</p>
          </td>
        </tr>
      </table>
    </td>
