          ...
          <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
            ...
            <tr class="mobile-valign-top">
              <td style="padding: 20px; font-size: 16px; ">
                  ...
                  <a href="https://readybpm.com/changepass/?email=<? echo $email; ?>&token=<? echo $token; ?>" style="background: darkred; padding: 10px; color: white; border-radius: 7px; text-align: center; ">CAMBIAR CONTRASEÑA</a>
              </td>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
        ...
        <td style="padding: 30px 0;">
            ...
            <tr>
              <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; text-align: left;">
                <a href="http://example.com" style="text-decoration: none;">
                  <img class="mobile-center" src="https://videoremixpool.com/images/logo.png" width="105" alt="VIDEOREMIXPOOL.COM" style="border: 0; width: 100%; max-width: 105px;">
                </a>
              </th>
            </tr>
            <tr>
          ...
          <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
            ...
            <tr class="mobile-valign-top">
              <td style="padding: 20px; font-size: 16px; ">
                  Haz click en el siguiente enlace para cambiar tu contraseña:<br><br>
                  <a href="https://videoremixpool.com/changepass/?email=<? echo $email; ?>&token=<? echo $token; ?>" style="background: #3e6ced; padding: 10px; color: white; border-radius: 7px; text-align: center; ">CAMBIAR CONTRASEÑA</a>
              </td>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
            ...
            <tr>
              <th class="column has-columns" width="640" style="padding-left: 30px; padding-right: 30px;">
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif">&copy; ReadyBPM. Todos los derechos reservados <a href="https://videoremixpool.com" style="color: #969AA1; text-decoration: none;">Terminos &amp; Condiciones</a></div>
                    </th>
                  </tr>
                  <tr>
                    <td class="spacer" height="30" style="font-size: 30px; line-height: 30px; mso-line-height-rule: exactly;">&nbsp;</td>
