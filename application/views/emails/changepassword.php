          ...
          <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
            ...
            <tr class="mobile-valign-top">
              <td style="padding: 20px; font-size: 16px; ">
                  ...
                  <a href="http://localhost/readybpm/changepass/?email=<? echo $email; ?>&token=<? echo $token; ?>" style="background: darkred; padding: 10px; color: white; border-radius: 7px; text-align: center; ">CAMBIAR CONTRASEÑA</a>
              </td>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
                        ...
                        <tr>
                          <td style="padding-left: 0;">
                            <a href="https://www.facebook.com/profile.php?id=61576190996039" style="text-decoration: none;">
                              <img src="http://localhost/readybpm/images/icons/facebook.png" width="24" alt="Twitter" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                          <td>
        ...
        <td style="padding: 30px 0;">
          ...
          <table class="row" align="center" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
            ...
            <tr class="mobile-valign-top">
              <td style="padding: 20px; font-size: 16px; ">
                  Haz click en el siguiente enlace para cambiar tu contraseña:<br><br>
                  <a href="http://localhost/readybpm/changepass/?email=<? echo $email; ?>&token=<? echo $token; ?>" style="background: #3e6ced; padding: 10px; color: white; border-radius: 7px; text-align: center; ">CAMBIAR CONTRASEÑA</a>
              </td>
            </tr>
            <tr>
              <td class="spacer" height="80" style="font-size: 80px; line-height: 80px; mso-line-height-rule: exactly;">&nbsp;</td>
            ...
            <tr>
              <th class="column has-columns" width="640" style="padding-left: 30px; padding-right: 30px;">
                  ...
                  <tr valign="top" style="vertical-align: top;">
                    <th class="column mobile-padding-bottom" width="255" style="padding-top: 10px; padding-right: 10px; text-align: left;">
                      <a href="http://localhost/readybpm/">
                        <img src="http://localhost/readybpm/images/icon-white.png" width="78" alt="VIDEOREMIXPOOL.COM" style="border: 0; width: 100%; max-width: 38px;">
                      </a>
                    </th>
                    <th class="column mobile-text-left" width="365" style="padding-left: 10px;">
                      <table align="right" class="mobile-left" cellpadding="10" cellspacing="0">
                        <tr>
                          ...
                          <td>
                            <a href="http://twitter.com/videoremixpool/" style="text-decoration: none;">
                              <img src="http://localhost/readybpm/images/icons/twitter.png" width="24" alt="Facebook" style="border: 0; width: 100%; max-width: 24px;">
                            </a>
                          </td>
                        </tr>
                      </table>
                ...
                <table class="row" cellpadding="0" cellspacing="0">
                  <tr>
                    <th class="column" width="640" style="color: #969AA1; font-weight: 400; text-align: left;">
                      <div class="sans-serif">&copy; ReadyBPM. Todos los derechos reservados <a href="http://localhost/readybpm/" style="color: #969AA1; text-decoration: none;">Terminos &amp; Condiciones</a></div>
                    </th>
                  </tr>
                  <tr>
                    <td class="spacer" height="30" style="font-size: 30px; line-height: 30px; mso-line-height-rule: exactly;">&nbsp;</td>
