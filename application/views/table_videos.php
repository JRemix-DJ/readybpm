                    ...
                    <tbody>
                        ...
                        foreach($products as $producto){
                            ...
                            <tr id="singleVideoPlayer-<? echo $i; ?>" data-product="<? echo $producto->id; ?>"class="song-unit singleVideoPlayer player-<? echo $producto->id; ?>" data-before="<? echo $i; ?>">
                                <td class="">
                                    <div class="thumb_container"  id="singleVideo-jplayer-<? echo $i; ?>" data-mp3="https://videoremixpool.com/assets/products/demos/videos/<? echo $producto->demo; ?>" data-title="<? echo $producto->name; ?>">
                                ...
                                <td class="song-title jp-title">
                                    <em><? echo $producto->name; ?> - <? echo $producto->artist; ?></em> - <span class="intro"><? if($producto->version!=null){ ?><? echo $producto->version; ?><? } ?></span> - <? echo $producto->bpm; ?>BPM -  <? $key = array_search($producto->gender_id, array_column($generos, 'id'));echo '<a href="'.base_url().'genero/'.$generos[$key]->id.'">'.$generos[$key]->name.'</a>'; ?><br>
                                    <small>Created at: <? 
                                ...
                                <? }else{ ?>
                                    ...
                                    <? if(MONEY_PAYMENTS){ ?>
                                        ...
                                        <? }else{ ?>
                                            <td class="tcenter">    
                                                <button class="song-btn downloadButtonVideo btn btn-orange" data-id="<? echo $producto->id; ?>"><i class="fa fa-download"></button>
                                            </td>
                                        <? } ?>
                                    <? }else{ ?>
                                        <td class="tcenter buton-tcenter">    
                                            <button class="song-btn downloadButtonVideo btn btn-orange" data-id="<? echo $producto->id; ?>"><i class="fa fa-download"></i></i><span class="descargar-movil">Descargar</span></button>
                                        </td>
                                    <? } ?>
                                <? } ?>
                            </tr> 
