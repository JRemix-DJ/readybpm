              ...
              <tbody>
                ...
                <? foreach($pagos as $pago) { ?>
                  <tr>
                    ...
                    <a href="<? echo base_url('admin/detalles_pago/').$pago->uid;; ?>" class="btn btn-warning">Ver Detalles</a>
                    <? if($this->session->userdata('role')=='is_admin') { ?>
                      <a href="<? echo base_url('admin/pago_a_dj/').$pago->uid;; ?>" class="btn btn-success">Pagar</a>
                    <? } ?>
                    </td>
                  </tr>
                <? } ?>
