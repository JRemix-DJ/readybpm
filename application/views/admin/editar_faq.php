      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <div class="form-layout">
            <? echo form_open_multipart(base_url().'admin/update_faq'); ?>
            <div class="row mg-b-25">
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="form-control-label">Titulo: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="title" value="<? echo $faq->title; ?>" placeholder="Ingrese Titulo">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="form-control-label">Contenido: <span class="tx-danger">*</span></label>
                  <textarea name="content" id="" cols="30" rows="10" class="form-control"><? echo $faq->content; ?></textarea>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="form-control-label">URL: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="slug" step="any" value="<?  echo $faq->slug; ?>" placeholder="Ingrese Slug de URL">
                </div>
              </div><!-- col-4 -->
            </div><!-- row -->
            <? echo form_hidden('id', $faq->id);?>
