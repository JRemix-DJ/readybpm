            ...
            <div class="row mg-b-25">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="title" value="<? echo $faq->title; ?>"
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea name="content" id="" cols="30" rows="10"
                                  class="form-control"><? echo $faq->content; ?></textarea>
                    </div>
                </div><!-- col-4 -->
                <div class="col-lg-12">
                    <div class="form-group">
                        <label class="form-control-label">URL: <span class="tx-danger">*</span></label>
                        <input class="form-control" type="text" name="slug" step="any" value="<?  echo $faq->slug; ?>"
                               placeholder="Ingrese Slug de URL">
                    </div>
                </div><!-- col-4 -->
            </div><!-- row -->
