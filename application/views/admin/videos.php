...
<div class="sl-pagebody">
    ...
    <div class="top_btn"><a href="https://videoremixpool.com/admin/nuevo_producto/" class="btn btn-success">Añadir
            Nuevo</a></div>
                            ...
                            <tr class="video_product" id="producto<? echo $i; ?>">
                                ...
                                <td class="align-middle">
                                    <div class="video_demo"
                                         data-mp4="<? echo base_url() . 'assets/products/demos/videos/' . $producto -> demo; ?>"
                                         id="player<? echo $i; ?>"></div>
                                ...
                                <td class="actions align-middle">
                                    <? if (($role == 'is_admin' || $role == 'is_subadmin') || ($this -> input -> get('aprobacion') == 1)) { ?>
                                        <a href="<? echo base_url(); ?>admin/editar_producto/?product_id=<? echo $producto -> id . '&paginationnumber=' . $paginationnumber; ?>"
                                    ...
                                    <? if (($role == 'is_admin' || $role == 'is_subadmin') && ($this -> input -> get('aprobacion') !== null)) { ?>
                                        <a href="<? echo base_url(); ?>admin/listar_videos/?aprobacion=1&action=approve&product_id=<? echo $producto -> id; ?>"
                                           class="btn btn-success btn-sm">Aprobar</a>
                                    <? } ?>
                                    <? if (($role == 'is_admin' || $role == 'is_subadmin') && ($this -> input -> get('aprobacion') == null)) { ?>
                                        <a href="<? echo base_url(); ?>admin/listar_videos/?action=disapprove&product_id=<? echo $producto -> id; ?>"
                                           class="btn btn-warning btn-sm">Desaprobar</a>
                                    <? } ?>
                                    <? if (($role == 'is_admin' || $role == 'is_subadmin')) { ?>
                                        <a href="<? echo base_url(); ?>products/descargar_admin/<? echo $producto -> id; ?>"
                                           class="btn btn-primary btn-sm">Descargar</a>
                                    <? } ?>
                                    <? if (($role == 'is_admin' || $role == 'is_subadmin') || ($this -> input -> get('aprobacion') == 1)) { ?>
                                        <a href="<? echo base_url(); ?>admin/listar_videos/?<? if ($this -> input -> get('aprobacion') != null) {
                                            echo 'aprobacion=1&';
                                        } ?>action=delete&product_id=<? echo $producto -> id; ?>"
