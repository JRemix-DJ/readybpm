...
<div class="sl-pagebody">
    ...
    <div class="top_btn"><a href="http://localhost/readybpm/admin/add_video/" class="btn btn-success">Añadir
            Nuevo</a></div>
                            ...
                            <tr class="video_product" id="producto<? echo $i; ?>">
                                ...
                                <td class="align-middle">
                                    <div class="video_demo"
                                         data-mp4="<? echo base_url().'assets/products/demos/'.$producto->demo; ?>"
