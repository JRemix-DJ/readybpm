            ...
            <table id="datatable1" class="table display responsive nowrap text-center">
                ...
                <? if ($ordenes) { ?>
                    <? foreach ($ordenes as $orden) { ?>
                        <tr class="<? if ($orden->txn_id == "MANUAL") {
                            ...
                            <td>
                                <? if ($orden->txn_id != "MANUAL") { ?>
                                    <a href="<? echo base_url('payment/aplicar_orden/?order_id=') . $orden->id; ?>"
                                       class="btn btn-success">Aplicar Plan</a>
                                <? } else { ?>
                                    <a href="<? echo base_url('payment/aplicar_orden/?renovacion=1&order_id=') . $orden->id; ?>"
                                       class="btn btn-danger">Renovar Plan</a>
                                <? } ?>
                            </td>
                        </tr>
                    <? } ?>
