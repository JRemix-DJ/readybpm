									...
									foreach($products as $producto) { 
										...
										<tr class="audio_product" id="producto<? echo $i; ?>">
											...
											<td class="align-middle">
												...
												<td class="align-middle">
													<div class="audio_demo" data-mp3="<? echo base_url().'assets/products/demos/'.$producto->demo; ?>" id="player<? echo $i; ?>"></div>
											...
											<td class="actions align-middle">
												...
												<? if(($role=='is_admin' || $role=='is_subadmin')&&($this->input->get('aprobacion')!==null)){ ?>
													<a href="<? echo base_url(); ?>admin/listar_productos/?aprobacion=1&action=approve&product_id=<? echo $producto->id; ?>" class="btn btn-success btn-sm">Aprobar</a>
												<? } ?>
												<? if(($role=='is_admin' || $role=='is_subadmin')&&($this->input->get('aprobacion')==null)){ ?>
													<a href="<? echo base_url(); ?>admin/listar_productos/?action=disapprove&product_id=<? echo $producto->id; ?>" class="btn btn-warning btn-sm">Desaprobar</a>
												<? } ?>
												...
												<? } ?>
												<? if(($role=='is_admin' || $role=='is_subadmin')||($this->input->get('aprobacion')==1)){ ?>
												<a href="<? echo base_url(); ?>admin/listar_productos/?<? if($this->input->get('aprobacion')!=null){ echo 'aprobacion=1&';} ?>action=delete&product_id=<? echo $producto->id; ?>" class="btn btn-danger btn-sm">Delete</a>
											<? } ?>
