                ...
                <? if ( isset($products) ) { ?>
                    <? if ( $products ) { ?>
                        ...
                        foreach ($products as $producto) {
                            $i++;
                            ?>
                            <tr class="audio_product" id="producto<? echo $i; ?>">
                                ...
                                <td class="align-middle">
                                    <div class="audio_demo"
                                         data-mp3="<? echo base_url() . 'assets/products/demos/' . $producto->demo; ?>"
                                ...
                                <td class="actions align-middle">
                                    ...
                                    <? if ( ($role == 'is_admin' || $role == 'is_subadmin') && ($this->input->get('aprobacion') !== null) ) { ?>
                                        <a href="<? echo base_url(); ?>admin/listar_productos/?aprobacion=1&action=approve&product_id=<? echo $producto->id; ?>"
                                           class="btn btn-success btn-sm">Aprobar</a>
                                    <? } ?>
                                    <? if ( ($role == 'is_admin' || $role == 'is_subadmin') && ($this->input->get('aprobacion') == null) ) { ?>
                                        <a href="<? echo base_url(); ?>admin/listar_productos/?action=disapprove&product_id=<? echo $producto->id; ?>"
                                    ...
                                    <? } ?>
                                    <? if ( ($role == 'is_admin' || $role == 'is_subadmin') || ($this->input->get('aprobacion') == 1) ) { ?>
                                        <a href="<? echo base_url(); ?>admin/listar_productos/?<? if ( $this->input->get('aprobacion') != null ) {
                                            echo 'aprobacion=1&';
